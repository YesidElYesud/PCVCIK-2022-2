...
#define WIFI_NETWORK "Meli"
#define WIFI_PASSWORD "consentida"
...
float A[2][2] = {{1, 0.05}, {0, 1}}; // Matriz de transición de estado 
float H[2][2] = {{1, 0}, {0, 1}}; // Matriz de observación 
float Q[2][2] = {{0.001, 0}, {0, 0.001}}; // Matriz de ruido del proceso
float R[2][2] = {{0.00000127186019570198, 0}, {0, 0.00429478327689053}}; // Matriz de ruido de la medición 
...
void lecturaBno055 (){
  ...
  imu::Vector<3> gyro_mac = sensor.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);

  // Crear el vector de medición Z
  float Z[2] = {euler.x(), gyro_mac.x()};
  ...
  Serial.print("Ángulo: "); Serial.print(x[0]* 180/M_PI);
  //  Finaliza
