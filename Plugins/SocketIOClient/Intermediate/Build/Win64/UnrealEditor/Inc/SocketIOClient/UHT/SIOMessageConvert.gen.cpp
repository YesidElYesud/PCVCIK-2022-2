...
template<> SOCKETIOCLIENT_API UScriptStruct* StaticStruct<FSIOConnectParams>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_263549292(TEXT("/Script/SocketIOClient"),
		Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_yesid_OneDrive_Im_genes_Escritorio_xd_HostProject_Plugins_SocketIOClient_Source_SocketIOClient_Public_SIOMessageConvert_h_Statics::ScriptStructInfo),
		nullptr, 0);
