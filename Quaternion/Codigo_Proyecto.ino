...
void loop() {
 ...
 // bateriaRevision();
  ...
  json = GetJSONString ("hand", pitch, roll, yaw, A, B, C); //Definición del JSON
  // Serial.println(json);
  UDPSendData(json);
